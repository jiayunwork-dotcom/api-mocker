...
CREATE INDEX idx_api_dependencies_project ON api_dependencies(project_id);
CREATE INDEX idx_api_dependencies_upstream ON api_dependencies(upstream_api_id);
CREATE INDEX idx_api_dependencies_downstream ON api_dependencies(downstream_api_id);
CREATE INDEX idx_impact_reports_project ON impact_reports(project_id);
CREATE INDEX idx_impact_reports_created ON impact_reports(project_id, created_at DESC);
CREATE INDEX idx_impact_reports_changed_api ON impact_reports(changed_api_id);
